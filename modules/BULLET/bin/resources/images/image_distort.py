...
if __name__ == "__main__":
    cv_right_image = cv2.imread("trial.png", 1)
    # cv_right_image.resize(300,300)
    lense_distort = ImageLenseDistort()
    cv_right_image_distorted = lense_distort.process_frame(cv_right_image)
    cv2.imshow('image',cv_right_image_distorted)
    cv2.waitKey(0)
